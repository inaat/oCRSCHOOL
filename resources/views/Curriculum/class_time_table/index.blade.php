...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">@lang('lang.timetables')</div>
            <div class="ps-3">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title text-primary">@lang('lang.classes_timetable')<br>
                    </small>
                </h5>
                ...
                <div class="d-lg-flex align-items-center mb-4 gap-3">
                    ...
                    <div class="ms-auto"><button type="button" class="btn btn-primary radius-30 mt-2 mt-lg-0 btn-modal" data-href="{{ action('Curriculum\ClassTimeTableController@create') }}" data-container=".time_table_modal">
                            <i class="bx bxs-plus-square"></i>@lang('lang.assign_period')</button></div>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-3">
                        ...
                        {!! Form::select('campus_id', $campuses, $campus_id,['class' => 'form-select select2 global-campuses','style' => 'width:100%', 'required', 'placeholder' => __('messages.please_select')]) !!}
                    </div>
                    <div class="col-sm-3">
                        {!! Form::label('class.classes', __('class.classes') . ':') !!}
                        {!! Form::select('class_id',$classes,$class_id, ['class' => 'form-select select2 global-classes ','style' => 'width:100%', 'placeholder' => __('messages.please_select')]) !!}
                    </div>
                    <div class="col-sm-3">
                        {!! Form::label('class_section.sections', __('class_section.sections') . ':') !!}
                        {!! Form::select('class_section_id', $class_sections, $class_section_id, ['class' => 'form-select select2 global-class_sections', 'style' => 'width:100%', 'placeholder' => __('messages.please_select')]) !!}
                    </div>
                    ...
                    <table class="table mb-0" width="100%" id="class_time_table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> <a data-href="{{ action('Curriculum\ClassTimeTableController@edit', [$time_table->id])}}" class="edit_time_table">{{$time_table->subjects->name }}<br>@if(!empty($time_table->subjects->employees)) <strong>({{ ucwords($time_table->subjects->employees->first_name . ' ' . $time_table->subjects->employees->last_name) }})@endif</strong></a></td>
                                @else

                                <td style="text-align:center;   vertical-align: middle;
 writing-mode: vertical-lr;"><a data-href="{{ action('Curriculum\ClassTimeTableController@edit', [$time_table->id])}}" class="edit_time_table">@lang('lang.'.$time_table->periods->type)</a></td>
                                @endif
                                @endforeach
                            </tr>
                            @endforeach
