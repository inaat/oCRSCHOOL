    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">@lang('lang.all_your_study_periods')</div>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">@lang('lang.study_period')</li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title text-primary">@lang('lang.study_period')<br>
                    ...
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        ...
                        <div class="ms-auto"><button type="button"
                                ...
                                data-href="{{ action('Curriculum\ClassTimeTableController@create') }}" data-container=".period_modal">
                                <i class="bx bxs-plus-square"></i>@lang('lang.add_new_period')</button></div>
