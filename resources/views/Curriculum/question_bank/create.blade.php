        ...
        <div class="modal-body">
            <div class="row m-0">
                <div class="col-md-4 p-2 ">
                    ...
                    {!! Form::select('chapter_number', $chapters, null, ['class' => 'form-select select2  chapter-lessson', 'required', 'style' => 'width:100%', 'placeholder' => __('messages.please_select')]) !!}
                </div>
                <div class="col-md-4 p-2 ">
                    {!! Form::label('lessons_id', __('lang.lessons') . ':*') !!}
                    {!! Form::select('lessons_id', [], null, ['class' => 'form-select select2', 'required', 'id' => 'lessons_ids','style' => 'width:100%', 'placeholder' => __('messages.please_select')]) !!}
                </div>
