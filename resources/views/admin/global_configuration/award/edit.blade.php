...
<div class="modal-dialog modal-lg" role="document">
    ...
    {!! Form::open(['url' => action('\App\Http\Controllers\AwardController@update', [$award->id]), 'method' => 'PUT', 'id' => 'award_edit_form' ]) !!}
        ...
        <div class="modal-header bg-primary">
            <h5 class="modal-title" id="exampleModalLabel">@lang('award.edit_award')</h5>
        ...
        {!! Form::label('award', __( 'award.award_title' ) . ':*') !!}
          {!! Form::text('title', $award->title, ['class' => 'form-control', 'required', 'placeholder' => __( 'award.award_title' ) ]); !!}
            </div>

            <div class="col-md-12 p-3">
                {!! Form::label('award', __( 'award.award_description' ) . ':*') !!}
