...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">@lang('class_level.manage_your_class_levels')</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">@lang('class_level.class_levels')</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title text-primary">@lang('class_level.class_levels_list')
                ...
                <div class="d-lg-flex align-items-center mb-4 gap-3">
                    ...
                    <div class="ms-auto"><button type="button" class="btn btn-primary radius-30 mt-2 mt-lg-0 btn-modal" data-href="{{ action('ClassLevelController@create') }}" data-container=".class_level_modal">
                            <i class="bx bxs-plus-square"></i>@lang('class_level.add_new_class_level')</button></div>
                ...
                <div class="table-responsive">
                    <table class="table mb-0" width="100%" id="class_levels_table">
                        <thead class="table-light" width="100%">
                            <tr>
                                <th>@lang('class_level.class_level_title')</th>
                                <th>@lang('class_level.description')</th>
