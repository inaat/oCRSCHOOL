...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">@lang('campus.manage_your_campuses')</div>
            <div class="ps-3">
        ...
        <div class="card">
            <div class="card-body">
                            <h5 class="card-title text-primary">@lang('campus.campuses_list')</h5>

                <div class="d-lg-flex align-items-center mb-4 gap-3">
                    <div class="ms-auto"><a class="btn btn-primary radius-30 mt-2 mt-lg-0" href="{{ action('CampusController@create') }}">
                            <i class="bx bxs-plus-square"></i>@lang('campus.add_new_campus')</a></div>
                </div>
                    ...
                    <table class="table mb-0" width="100%" id="campuses_table">
                        <thead class="table-light" width="100%">
                            <tr>
                                ...
                                <th>@lang('campus.registration_date')</th>
                                <th>@lang('campus.registration_code')</th>
