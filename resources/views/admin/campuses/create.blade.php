...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title text-primary">@lang('campus.add_new_campus')</h5>
                <div class="row">
                    <div class="col-md-4 p-3">
                        {!! Form::label('campus_name', __('campus.campus_name') . ':*', ['classs' => 'form-lable']) !!}
                        {!! Form::text('campus_name', null, ['class' => 'form-control', 'required', 'placeholder' => __('campus.campus_name')]) !!}

                    </div>
                    <div class="col-md-4 p-3">
                        {!! Form::label('registration_code', __('campus.registration_code') . ':*') !!}
                        {!! Form::text('registration_code', null, ['class' => 'form-control','required', 'placeholder' => __('campus.registration_code')]) !!}
                    </div>
                    <div class="col-md-4 p-3">
                        ...
                        <div class="input-group flex-nowrap"> <span class="input-group-text" id="addon-wrapping"><i class="fa fa-calendar"></i></span>
                            ...
                            {!! Form::text('registration_date', @format_date('now'), ['class' => 'form-control start-date-picker', 'placeholder' => __('campus.registration_date'), 'readonly']) !!}
                    ...
                    <div class="col-md-4 p-3">
                        ...
                        {!! Form::text('mobile', null, ['class' => 'form-control', 'required', 'pattern' => '\d{11}','maxlength' => '11','placeholder' => __('lang_v1.mobile')]) !!}
                    </div>

                    <div class="col-md-4 p-3">
                        {!! Form::label('phone', __('lang_v1.phone') . ':') !!}
                        {!! Form::text('phone', null, ['class' => 'form-control','required', 'placeholder' => __('lang_v1.phone')]) !!}
                    </div>
                    <div class="col-md-4 p-3">
                        {!! Form::label('address', __('lang_v1.address') . ':', ['classs' => 'form-lable']) !!}
                        {!! Form::text('address', null, ['class' => 'form-control', 'required', 'placeholder' => __('lang_v1.address')]) !!}
