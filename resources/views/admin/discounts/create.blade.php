        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-md-6 p-3">
                    ...
                    {!! Form::select('discount_type', ['fixed' => __('lang_v1.fixed'), 'percentage' => __('lang_v1.percentage')], null, ['style' => 'width:100%', 'placeholder' => __('messages.please_select'), 'class' => 'form-select  select2', 'required']); !!}
