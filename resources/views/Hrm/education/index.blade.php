    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">@lang('hrm.all_your_educations')</div>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">@lang('hrm.educations')</li>
                        </ol>
                    </nav>
                </div>
                <div class="ms-auto">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title text-primary">@lang('hrm.education_list')
                    ...
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        ...
                        <div class="ms-auto"><button type="button"
                                ...
                                <i class="bx bxs-plus-square"></i>@lang('hrm.add_new_education')</button></div>
