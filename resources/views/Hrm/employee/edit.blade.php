                ...
                <div class="card-body">
                        ...
                        <div class="col-md-10">
                            <div class="row">
                                <div class="col-md-4 p-1">
                                    ...
                                    {!! Form::select('campus_id', $campuses,$employee->campus_id, ['class' => 'form-select select2 campuses', 'required', 'style' => 'width:100%', 'required', 'placeholder' => __('messages.please_select'), 'id' => 'campus_id']) !!}
                                </div>

                                <div class="col-md-4 p-1">
                                    {!! Form::label('employeeID', __('hrm.employee_id') . ':*', ['classs' => 'form-lable']) !!}
                                    {!! Form::text('employeeID', $employee->employeeID, ['class' => 'form-control', 'required', 'readonly', 'placeholder' => __('hrm.employee_id')]) !!}

                                </div>
                                <div class="col-md-4 p-1">
                                    {!! Form::label('lang.first_name', __('lang.first_name') . ':*') !!}
                                    {!! Form::text('first_name',$employee->first_name, ['class' => 'form-control', 'required', 'placeholder' => __('lang.first_name')]) !!}
                                </div>
                                ...
                                <div class="col-md-4 p-1">
                                    ...
                                    {!! Form::text('last_name',$employee->last_name, ['class' => 'form-control', 'placeholder' => __('lang.last_name')]) !!}
                                </div>
                                <div class="col-md-4 p-1">
                                    {!! Form::label('lang.father_name', __('lang.father_name') . ':*') !!}
                                    {!! Form::text('father_name', $employee->father_name, ['class' => 'form-control', 'required', 'id' => 'father_name', 'placeholder' => __('lang.father_name')]) !!}
                                </div>
                                <div class="col-md-4 p-1">
                                    {!! Form::label('lang.gender', __('lang.gender') . ':*') !!}
                                    {!! Form::select('gender', ['male' => __('lang_v1.male'), 'female' => __('lang_v1.female'), 'others' => __('lang_v1.others')],$employee->gender, ['class' => 'form-select select2 ', 'required', 'style' => 'width:100%', 'required', 'placeholder' => __('messages.please_select')]) !!}
                                </div>
                                <div class="clearfix"></div>
                                ...
                                <div class="col-md-4 p-1">
                                    ...
                                    <div class="input-group flex-nowrap"> <span class="input-group-text"
                                        ...
                                        {!! Form::text('birth_date', @format_date($employee->birth_date), ['class' => 'form-control start-date-picker', 'placeholder' => __('lang.date_of_birth')]) !!}
                                ...
                                <div class="col-md-4 p-1">
                                    ...
                                    <div class="input-group flex-nowrap"> <span class="input-group-text"
                                        ...
                                        {!! Form::text('joining_date', @format_date($employee->joining_date), ['class' => 'form-control date-picker', 'readonly', 'placeholder' => __('hrm.joining_date')]) !!}
                             ...
                             <div class="clearfix"></div>
                                ...
                                <div class="col-md-3 p-1">
                                    ...
                                    <input type="text" name="mobile_no" class="mobile form-control" value="{{$employee->mobile_no }}">
                                ...
                                <div class="col-md-3 p-1">
                                    ...
                                    {!! Form::select('blood_group', ['O+' => 'O+', 'O-' => 'O-', 'A+' => 'A+', 'A-' => 'A-', 'B+' => 'B+', 'B-' => 'B-', 'AB+' => 'AB+', 'AB-' => 'AB-'],$employee->blood_group, ['class' => 'form-select select2 ', 'style' => 'width:100%', 'placeholder' => __('messages.please_select')]) !!}
                                </div>

                                <div class="clearfix"></div>
                                <div class="col-md-3 p-1">
                                    {!! Form::label('nationality', __('lang.nationality') . ':') !!}
                                    {!! Form::text('nationality',$employee->nationality, ['class' => 'form-control', 'placeholder' => __('lang.nationality')]) !!}

                                </div>
                                <div class="col-md-3 p-1">
                                    {!! Form::label('mother_tongue', __('lang.mother_tongue') . ':') !!}
                                    {!! Form::text('mother_tongue',$employee->mother_tongue, ['class' => 'form-control', 'placeholder' => __('lang.mother_tongue')]) !!}
                                ...
                                <div class="card border-top border-0 border-4 border-info">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::select('country_id', $countries, $employee->country_id, ['class' => 'form-select select2 ', 'required', 'id' => 'country_id', 'style' => 'width:100%', 'required', 'placeholder' => __('lang.please_select')]) !!}
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::select('province_id',$provinces, $employee->province_id, ['class' => 'form-select select2 ', 'required', 'style' => 'width:100%', 'required', 'id' => 'provinces_ids', 'placeholder' => __('lang.please_select')]) !!}
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::select('district_id', $districts,$employee->district_id, ['class' => 'form-select select2 ', 'required', 'style' => 'width:100%', 'required', 'id' => 'district_ids', 'placeholder' => __('lang.district_name')]) !!}
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::select('city_id',$cities,$employee->city_id, ['class' => 'form-select select2 ', 'required', 'style' => 'width:100%', 'required', 'id' => 'city_ids', 'placeholder' => __('lang.city_name')]) !!}
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::select('region_id',$regions,$employee->region_id, ['class' => 'form-select select2 ', 'required', 'id' => 'region_ids', 'style' => 'width:100%', 'required', 'placeholder' => __('messages.please_select')]) !!}
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::textarea('current_address',$employee->current_address, ['class' => 'form-control ', 'rows' => 1, 'placeholder' => __('lang.current_address')]) !!}
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::textarea('permanent_address',$employee->permanent_address, ['class' => 'form-control ', 'rows' => 1, 'placeholder' => __('lang.permanent_address')]) !!}
                                ...
                                <div class="card border-top border-0 border-4 border-info">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::text('bank_details[account_name]',$bank_details->account_name, ['class' => 'form-control', 'placeholder' => __('hrm.account_holder')]) !!}
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::text('bank_details[account_number]', $bank_details->account_number, ['class' => 'form-control', 'placeholder' => __('hrm.account_number')]) !!}
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::text('bank_details[bank]',$bank_details->bank, ['class' => 'form-control', 'placeholder' => __('hrm.bank')]) !!}
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::text('bank_details[bin]',$bank_details->bin, ['class' => 'form-control', 'placeholder' => __('hrm.bin')]) !!}
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::text('bank_details[branch]',$bank_details->branch, ['class' => 'form-control', 'placeholder' => __('hrm.branch')]) !!}
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::text('bank_details[tax_payer_id]',$bank_details->tax_payer_id, ['class' => 'form-control', 'placeholder' => __('hrm.tax_payer_id')]) !!}
                    ...
                    <div class="row pt-4">
                        ...
                        <div class="col-md-4  p-1">
                            ...
                            {!! Form::select('department_id', $departments, $employee->department_id, ['class' => 'form-select select2', 'style' => 'width:100%', 'placeholder' => __('messages.please_select'), 'id' => 'department_id']) !!}
                        </div>
                        <div class="col-md-4  p-1">
                            {!! Form::label('hrm.designations', __('hrm.designations') . ':*') !!}
                            {!! Form::select('designation_id', $designations,$employee->designation_id, ['class' => 'form-select select2', 'style' => 'width:100%', 'placeholder' => __('messages.please_select'), 'id' => 'designation_id']) !!}
                        </div>
                        <div class="col-md-4  p-1">
                            {!! Form::label('hrm.educations', __('hrm.educations') . ':*') !!}
                            {!! Form::select('education_id', $educations, $employee->education_id, ['class' => 'form-select select2', 'style' => 'width:100%', 'placeholder' => __('messages.please_select'), 'id' => 'education_id']) !!}
                        </div>
                    ...
                    <div class="row pt-4">
                        ...
                        <div class="col-md-6  p-1">
                            ...
                            <div class="input-group flex-nowrap"> <span class="input-group-text" id="addon-wrapping"><i
                                ...
                                {!! Form::text('basic_salary',@num_format($employee->basic_salary), ['class' => 'form-control input_number', 'required', 'placeholder' => __('hrm.basic_salary'), 'id' => 'basic salary']) !!}
                                {!! Form::select('pay_period', ['month' => __('hrm.per') . ' ' . __('hrm.month'), 'week' => __('hrm.per') . ' ' . __('hrm.week'), 'day' => __('hrm.per') . ' ' . __('hrm.day')], $employee->pay_period, ['class' => 'width-60 pull-left form-select select2']) !!}

                            </div>
                        </div>
                        <div class="col-md-6 p-1">
                            {!! Form::label('remark', __('lang.remark') . ':') !!}
                            {!! Form::textarea('remark',$employee->remark, ['class' => 'form-control', 'rows' => 3, 'placeholder' => __('lang.remark')]) !!}
                    ...
                    <div class="row pt-4">
                        ...
                        <div class="col-md-4 p-1">
                            ...
                            {!! Form::email('email', $employee->email, ['class' => 'form-control', 'placeholder' => __('lang.email'), 'id' => 'email']) !!}
                        </div>
                        <div class="col-md-4  p-1">
