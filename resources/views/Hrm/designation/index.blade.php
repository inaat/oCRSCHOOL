    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">@lang('hrm.all_your_designations')</div>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">@lang('hrm.designations')</li>
                        </ol>
                    </nav>
                </div>
                <div class="ms-auto">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title text-primary">@lang('hrm.designation_list')
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0" width="100%" id="designations_table">
                            <thead class="table-light" width="100%">
                                <tr>
                                    <th>@lang('hrm.designation_name')</th>
