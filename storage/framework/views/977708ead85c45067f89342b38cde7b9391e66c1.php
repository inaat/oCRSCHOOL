 ...
 <?php $__env->startSection('wrapper'); ?>
     <div class="page-wrapper">
         <div class="page-content">
                         ...
                         <div class="accordion-item">
                             <h2 class="accordion-header" id="employee-fillter">
                                 <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                     ...
                                     <h5 class="card-title"><?php echo app('translator')->get('hrm.employees_flitters'); ?></h5>
                                 </button>
                             </h2>
                                 ...
                                 <div class="accordion-body">
                                     <div class="row">
                                         <div class="col-md-3 p-1">
                                             ...
                                             <?php echo Form::select('campus_id', $campuses, null, ['class' => 'form-select select2 global-campuses', 'required', 'id' => 'employees_list_filter_campus_id', 'style' => 'width:100%', 'required', 'placeholder' => __('messages.all')]); ?>

                                         </div>
                                         <div class="col-md-3 p-1">
                                             <?php echo Form::label('employeeID', __('hrm.employeeID')); ?>

                                             <?php echo Form::text('employeeID', null, ['class' => 'form-control', 'placeholder' => __('hrm.employeeID'), 'id' => 'employees_list_filter_employeeID']); ?>

                                         </div>
                                         <div class="col-md-3 p-1">
                                             <?php echo Form::label('status', __('hrm.employee_status') . ':*'); ?>

                                             <?php echo Form::select('employees_list_filter', __('hrm.emp_status'), null, ['class' => 'form-select', 'id' => 'employees_list_filter', 'placeholder' => __('messages.all'), 'required']); ?>
                                         ...
                                         <div class="col-md-3 p-1">
                                             ...
                                             <div class="input-group flex-nowrap"> <span class="input-group-text"
                                                 ...
                                                 <?php echo Form::text('employees_list_filter_date_range', null, ['placeholder' => __('lang_v1.select_a_date_range'), 'id' => 'employees_list_filter_date_range', 'class' => 'form-control', 'readonly']); ?>
             ...
             <div class="card">
                 <div class="card-body">
                     <h5 class="card-title text-primary"><?php echo app('translator')->get('hrm.employee_list'); ?></h5>

                     <div class="d-lg-flex align-items-center mb-4 gap-3">
                         <div class="ms-auto"><a class="btn btn-primary radius-30 mt-2 mt-lg-0"
                                 href="<?php echo e(action('HRM\HrmEmployeeController@create'), false); ?>">
                                 <i class="bx bxs-plus-square"></i><?php echo app('translator')->get('hrm.add_new_employee'); ?></a></div>
                     </div>
     ...
     <?php echo $__env->make('Hrm/employee.partials.update_employee_status_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
     <?php echo $__env->make('Hrm/employee.partials.employee_resign_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make("admin_layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\scsserver\htdocs\oCRSCHOOL\resources\views/Hrm\employee/index.blade.php ENDPATH**/ ?>