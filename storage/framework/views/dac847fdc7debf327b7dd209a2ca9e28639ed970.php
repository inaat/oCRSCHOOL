...
<body>
        ...
        <div class="info" style="border:1px solid black;">
            <div class="column1">
               <div class='row'>
                    ...
                    <div class="mg-left"><strong><?php echo e(ucwords($std['current_transaction']->voucher_no), false); ?></strong>
                    </div>
                ...
                <div class='row'>
                    ...
                    <div class="mg-left"><strong><?php echo e(ucwords($std['current_transaction']->student->roll_no), false); ?></strong>
                    </div>
                ...
                <div class='row'>
                    ...
                    <div class="mg-left">
                        <strong><?php echo e(ucwords($std['current_transaction']->student->father_name), false); ?></strong></div>

                </div>
                <div class='row'>
                    <div class='label'> <strong><?php echo app('translator')->get('lang.address'); ?>:</strong></div>
                    <div class="mg-left"><?php echo e(ucwords($std['current_transaction']->student->std_permanent_address), false); ?></div>
    ...
    <div class="fee-received">
        <div class="mg-left">
            ...
            <div id="head1">
                <span style="font-size:10px"><?php echo app('translator')->get('lang.fee_upto_december_session'); ?>(<?php echo e($std['current_transaction']->session->title, false); ?>)</span>
            </div>
            <div class="">
                <div class="space" style="margin-top:px; width:100%;  height:5px;">
                </div>
                <div id="row">
                    <h4 class='label mg-left'> <strong><?php echo app('translator')->get('lang.roll_no'); ?></strong>
                        <span class="mg-left"><strong><?php echo e(ucwords($std['current_transaction']->student->roll_no), false); ?></strong></span>
                    </h4>
