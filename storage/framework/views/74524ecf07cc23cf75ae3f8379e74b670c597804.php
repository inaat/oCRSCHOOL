<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-header bg-primary">
            <h5 class="modal-title" id="exampleModalLabel"><?php echo app('translator')->get('class.add_new_class'); ?></h5>
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-md-6 p-3">
                    ...
                    <?php echo Form::text('title', null, ['class' => 'form-control', 'required', 'placeholder' => __('class.title')]); ?>
                ...
                <div class="col-md-6 p-3">
                    ...
                    <?php echo Form::text('tuition_fee', null, ['class' => 'form-control input_number', 'required', 'placeholder' => __( 'class.tuition_fee' ) ]); ?>
                ...
                <div class="col-md-6 p-3">
                    ...
                    <?php echo Form::text('admission_fee', null, ['class' => 'form-control input_number', 'required', 'placeholder' => __( 'class.admission_fee' ) ]); ?>
