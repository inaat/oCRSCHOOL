...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3"><?php echo app('translator')->get('class.manage_your_classes'); ?></div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page"><?php echo app('translator')->get('class.classes'); ?></li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                            <h5 class="card-title text-primary"><?php echo app('translator')->get('class.class_list'); ?></h5>
               ...
               <div class="d-lg-flex align-items-center mb-4 gap-3">
                    <div class="ms-auto"><button type="button"
                                ...
                                <i class="bx bxs-plus-square"></i><?php echo app('translator')->get('class.add_new_class'); ?></button></div>
                </div>
                    ...
                    <table class="table mb-0" width="100%" id="classes_table">
                        <thead class="table-light" width="100%">
                            <tr>
                                ...
                                <th><?php echo app('translator')->get('class.tuition_fee'); ?></th>
                                <th><?php echo app('translator')->get('class.admission_fee'); ?></th>
                            </tr>
                        </thead>
