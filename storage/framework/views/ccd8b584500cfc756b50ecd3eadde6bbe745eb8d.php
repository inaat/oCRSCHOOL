     ...
     <div class="page-wrapper">
         <div class="page-content">
             ...
             <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                 <div class="breadcrumb-title pe-3"><?php echo app('translator')->get('lang.fees_allocation'); ?></div>
                 <div class="ps-3">
                     <nav aria-label="breadcrumb">
                         <ol class="breadcrumb mb-0 p-0">
                             <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                             </li>
                             <li class="breadcrumb-item active" aria-current="page"><?php echo app('translator')->get('lang.fees_allocation'); ?></li>
                         </ol>
                     </nav>
                 </div>
             </div>
             <!--end breadcrumb-->
             <?php echo Form::open(['url' => action('FeeAllocationController@feesAssignSearch'), 'method' => 'post', 'class' => '', 'novalidate' . 'id' => 'search_student_fee', 'files' => true]); ?>
             ...
             <div class="row">
                         ...
                         <div class="card-body">
                             <div class="d-flex align-items-center">
                                 ...
                                 <div class="ms-3">
                                     ...
                                     <div class="text-dark">Tuition Fee And Transport Fee Already You had Assigned
                                         During The Admission</div>
                                 </div>
                             </div>
                         </div>
                     </div>
                 ...
                 <?php if(isset($students)): ?>
                     <?php echo Form::open(['url' => action('FeeAllocationController@store'), 'method' => 'post', 'class' => '', '' . 'id' => 'store_student_fee', 'files' => true]); ?>
...
<?php echo $__env->make("admin_layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\scsserver\htdocs\oCRSCHOOL\resources\views/fee_allocation/fees_assign.blade.php ENDPATH**/ ?>