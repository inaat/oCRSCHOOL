<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        <?php echo Form::open(['url' => action('FeeTransactionPaymentController@postPayStudentDue'), 'method' => 'post', 'id' => 'pay_employee_due_form', 'files' => true]); ?>


        <div class="modal-header bg-primary">
            <h5 class="modal-title" id="exampleModalLabel"><?php echo app('translator')->get('lang.view_payments'); ?>
                (<?php echo e(ucwords($transaction->ref_no), false); ?>)</h5>
                ...
                <div class="col-md-6">
                    <div class="card card-body bg-light">
                        <p>
                            ...
                            <strong><?php echo app('translator')->get('hrm.employeeID'); ?>:
                            </strong><?php echo e(ucwords($transaction->employee->employeeID), false); ?>
                ...
                <div class="col-md-6">
                    <div class="card card-body bg-light">
                        <p>
                            ...
                            </strong><?php echo e(ucwords($transaction->payment_status), false); ?></strong>
                        </p>
                    </div>
                </div>
            </div>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td><span class="display_currency"
                                            data-currency_symbol="true"><?php echo e($payment->amount, false); ?></span></td>
                                    ...
                                    <td class="no-print" style="display: flex;">
                                        <?php if($payment->method != 'advance_pay'): ?>
                                            ...
                                            <button type="button" class="btn btn-info btn-xs edit_payment"
                                                data-href="<?php echo e(action('HRM\HrmTransactionPaymentController@edit', [$payment->id]), false); ?>"><i
                                                    class="glyphicon glyphicon-edit"></i></button>
                                            &nbsp;
                                        <?php endif; ?>
                                        <button type="button" class="btn btn-danger btn-xs delete_payment"
                                            data-href="<?php echo e(action('HRM\HrmTransactionPaymentController@destroy', [$payment->id]), false); ?>"><i
                                                class="fa fa-trash" aria-hidden="true"></i></button>
                                        &nbsp;
                                        
                                        <?php if(!empty($payment->document_path)): ?>
                                            &nbsp;
                                            <a href="<?php echo e($payment->document_path, false); ?>" class="btn btn-success btn-xs"
                                                download="<?php echo e($payment->document_name, false); ?>"><i class="fa fa-download"
                                                    data-toggle="tooltip"
                                                    title="<?php echo e(__('purchase.download_document'), false); ?>"></i></a>
                                            <?php if(isFileImage($payment->document_name)): ?>
                                                &nbsp;
                                                <button data-href="<?php echo e($payment->document_path, false); ?>"
                                                    class="btn btn-info btn-xs view_uploaded_document"
                                                    data-toggle="tooltip" title="<?php echo e(__('lang_v1.view_document'), false); ?>"><i
...
<?php /**PATH C:\scsserver\htdocs\oCRSCHOOL\resources\views/Hrm\hrm_transaction_payment/show_payments.blade.php ENDPATH**/ ?>