               ...
               <div class="row ">
                ...
                <div class="col-md-4 p-1" id="datetimepicker"
                    ...
                    <div class="input-group flex-nowrap input-group-append  input-group date"> <span
                        ...
                        <?php echo Form::text('paid_on', null, ['class' => 'form-control datetimepicker-input', 'data-target' => '#datetimepicker', 'required']); ?>
