    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><?php echo app('translator')->get('hrm.all_your_leave_categories'); ?></div>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page"><?php echo app('translator')->get('hrm.leave_categories'); ?></li>
                        </ol>
                    </nav>
                </div>
                <div class="ms-auto">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title text-primary"><?php echo app('translator')->get('hrm.leave_category_list'); ?>
                    ...
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        ...
                        <div class="ms-auto"><button type="button"
                                ...
                                data-href="<?php echo e(action('HRM\HrmLeaveCategoryController@create'), false); ?>"
                                data-container=".leave_categories_modal">
                                <i class="bx bxs-plus-square"></i><?php echo app('translator')->get('hrm.add_new_leave_category'); ?></button></div>
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0" width="100%" id="leave_categories_table">
                            <thead class="table-light" width="100%">
                                <tr>
                                    <th><?php echo app('translator')->get('hrm.leave_category_name'); ?></th>
                                    <th><?php echo app('translator')->get('hrm.max_leave_count'); ?></th>
...
<?php echo $__env->make("admin_layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\scsserver\htdocs\oCRSCHOOL\resources\views/Hrm\leave_category/index.blade.php ENDPATH**/ ?>