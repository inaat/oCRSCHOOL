...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3"><?php echo app('translator')->get('lang.manage_your_heads'); ?></div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page"><?php echo app('translator')->get('lang.fee_heads'); ?></li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                            <h5 class="card-title text-primary"><?php echo app('translator')->get('lang.fee_head_list'); ?></h5>

               <div class="d-lg-flex align-items-center mb-4 gap-3">
                    <div class="ms-auto"><button type="button"
                                class="btn btn-primary radius-30 mt-2 mt-lg-0 btn-modal"
                                data-href="<?php echo e(action('FeeHeadController@create'), false); ?>"
                                data-container=".fee-head_modal">
                                <i class="bx bxs-plus-square"></i><?php echo app('translator')->get('lang.add_new_fee_head'); ?></button></div>
                </div>
                    ...
                    <table class="table mb-0" width="100%" id="fee_heead_table">
                        <thead class="table-light" width="100%">
                            <tr>
                                ...
                                <th><?php echo app('translator')->get('class.title'); ?></th>
                                <th><?php echo app('translator')->get('lang.fee_head'); ?></th>
                                <th><?php echo app('translator')->get('lang.fee_amount'); ?></th>
                            </tr>
                        </thead>
...
<?php echo $__env->make("admin_layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\scsserver\htdocs\oCRSCHOOL\resources\views/fee-heads/index.blade.php ENDPATH**/ ?>