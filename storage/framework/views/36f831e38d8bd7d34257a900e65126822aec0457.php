                    ...
                    <table class="table table-condensed table-striped " id="admisssion-table">
                        ...
                        <tbody>
                          ...
                          <?php $__currentLoopData = $fee_heads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fee_head): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                               <?php if($fee_head->description=='Admission'): ?>
                                   <tr>
                                ...
                                <td class="text-center ">
                                    <?php echo Form::text('fee_heads[<?php echo e($loop->iteration, false); ?>][amount]',number_format($classes->admission_fee, config('constants.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), ['class' => 'form-control input_number amount']); ?>
                               ...
                               <?php elseif($fee_head->description=='Prospectus'): ?>
                                   <tr>
                                <td class="text-center"><div class="mt-2"><?php echo e($fee_head->description, false); ?></div></td>
                                <td class="text-center">
                                ...
                                <td class="text-center ">
                                    <?php echo Form::text('fee_heads[<?php echo e($loop->iteration, false); ?>][amount]',number_format($classes->prospectus_fee, config('constants.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), ['class' => 'form-control input_number amount']); ?>
                               ...
                               <?php elseif($fee_head->description=='Security'): ?>
                                   <tr>
                                <td class="text-center"><div class="mt-2"><?php echo e($fee_head->description, false); ?></div></td>
                                <td class="text-center">
                                ...
                                <td class="text-center ">
                                    <?php echo Form::text('fee_heads[<?php echo e($loop->iteration, false); ?>][amount]',number_format($classes->security_fee, config('constants.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), ['class' => 'form-control input_number amount']); ?>
