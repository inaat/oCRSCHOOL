        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-md-12 ">
                    ...
                    <?php echo Form::select('from_account', $from_accounts, null, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select') ]); ?>
...
<?php /**PATH C:\scsserver\htdocs\oCRSCHOOL\resources\views/account/deposit.blade.php ENDPATH**/ ?>