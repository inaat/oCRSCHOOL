        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-md-6 p-3">
                    ...
                    <?php echo Form::text('transport_fee',number_format($classes->transport_fee, config('constants.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), ['class' => 'form-control input_number', 'required', 'placeholder' => __('lang.transport_fee')]); ?>
                ...
                <div class="col-md-6 p-3">
                    ...
                    <?php echo Form::text('security_fee',number_format($classes->security_fee, config('constants.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), ['class' => 'form-control input_number', 'required', 'placeholder' => __('lang.security_fee')]); ?>
                ...
                <div class="col-md-6 p-3">
                    ...
                    <?php echo Form::text('prospectus_fee',number_format($classes->prospectus_fee, config('constants.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']) ,['class' => 'form-control input_number', 'required', 'placeholder' => __('lang.prospectus_fee')]); ?>
