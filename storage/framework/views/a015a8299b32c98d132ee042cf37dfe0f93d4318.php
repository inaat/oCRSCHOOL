            ...
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6 p-3">
                    ...
                    <?php echo Form::text('title', null, ['class' => 'form-control title mask', 'required','min'=>8,'placeholder' => __( 'session.session_title' ) ]); ?>


                </div>

                <div class="col-md-6 p-3">
                    <?php echo Form::label('prefix', __('session.prefix') . ':*'); ?>

                    <?php echo Form::text('prefix', null, ['class' => 'form-control', 'required', 'placeholder' => __('session.prefix')]); ?>
