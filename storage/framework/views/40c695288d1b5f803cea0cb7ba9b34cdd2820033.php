 ...
 <?php $__env->startSection('wrapper'); ?>
     <div class="page-wrapper">
         <div class="page-content">
             ...
             <div class="card">
                 <div class="card-body">
                     <h5 class="card-title text-primary"><?php echo app('translator')->get('hrm.all_payroll_transaction'); ?></h5>

                     <div class="d-lg-flex align-items-center mb-4 gap-3">
                         <div class="ms-auto"><a class="btn btn-primary radius-30 mt-2 mt-lg-0"
                                 href="<?php echo e(action('HRM\HrmPayrollController@create'), false); ?>">
                                 <i class="bx bxs-plus-square"></i><?php echo app('translator')->get('hrm.add_new_payroll'); ?></a></div>
                     </div>
                         ...
                         <table class="table mb-0" width="100%" id="fee_transaction_table">
                             <thead class="table-light" width="100%">
                                 <tr>
                                     ...
                                     <th><?php echo app('translator')->get('hrm.transaction_date'); ?></th>
                                    ...
                                    <th><?php echo app('translator')->get('hrm.employee_name'); ?></th>
                                     ...
                                     <th><?php echo app('translator')->get('hrm.payroll_due'); ?></th>
...
<?php echo $__env->make("admin_layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\scsserver\htdocs\oCRSCHOOL\resources\views/Hrm\payroll/index.blade.php ENDPATH**/ ?>