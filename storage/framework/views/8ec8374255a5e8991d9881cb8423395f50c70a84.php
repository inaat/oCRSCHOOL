                      ...
                      <div class="card-body">
                              ...
                              <li class="nav-item" role="presentation">
                                  <a class="nav-link" data-bs-toggle="tab" href="#prefixes_setting" role="tab"
                                      ...
                                      <div class="d-flex align-items-center">
                                          ...
                                          <div class="tab-title">Question Bank</div>
                                      </div>
                                  </a>
                              </li>
                          ...
                          <div class="tab-content py-">
                              <div class="tab-pane fade" id="lesson" role="tabpanel">
                                <?php echo $__env->make('Exam.lesson.partials.lesson', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                              </div>
                              <div class="tab-pane fade show active" id="progress" role="tabpanel">
                                <?php echo $__env->make('Exam.progress.partials.progress', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                              </div>
...
<?php echo $__env->make("admin_layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\scsserver\htdocs\oCRSCHOOL\resources\views/Exam\lesson/index.blade.php ENDPATH**/ ?>