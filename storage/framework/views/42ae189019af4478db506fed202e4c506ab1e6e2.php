       ...
       $(document).on('click', '.edit_payment', function(e) {
        ...
        var fee_transaction_table = $("#fee_transaction_table").DataTable({
            ...
            , columns: [{
                 ...
                 , {
                    data: "final_total"
                    , name: "final_total" , orderable: false, "searchable": false
                }
                 , {
                    data: "total_paid"
                    , name: "total_paid" , orderable: false, "searchable": false
                }
                 , {
                    data: "total_remaining"
                    , name: "total_remaining" , orderable: false, "searchable": false
                }, {
                    data: "session_info"
                    , name: "session_info", orderable: false, "searchable": false
                }
                , {
                    data: "student_name"
                    , name: "student_name", orderable: false, "searchable": false
                }
                , {
                    data: "father_name"
                    , name: "father_name", orderable: false, "searchable": false
                }
                 , {
                    data: "status"
                ...
                , {
                    ...
                    data: "current_class"
                    , name: "current_class", orderable: false, "searchable": false
                }
