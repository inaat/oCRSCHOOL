      ...
      <div class="page-wrapper">
          <div class="page-content">
                  ...
                  <div class="ps-3">
                      <nav aria-label="breadcrumb">
                          <ol class="breadcrumb mb-0 p-0">
                              ...
                              <li class="breadcrumb-item active" aria-current="page"><?php echo app('translator')->get('lang.class'); ?></li>
                          </ol>
                      </nav>
                  </div>
              ...
              <div class="row row-cols-12 row-cols-md-1 row-cols-lg-12 row-cols-xl-12">
                  <h6 class="mb-0 text-uppercase text-info"> <?php echo app('translator')->get('lang.subject_detail'); ?> - <?php echo e($classes->title, false); ?></h6>
                  <hr />
                  <div class="card">
                      <div class="card-body">
...
<?php echo $__env->make("admin_layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\scsserver\htdocs\oCRSCHOOL\resources\views/admin\classes/profile.blade.php ENDPATH**/ ?>