 <div class="card">
     <div class="card-body">
         ...
         <?php echo Form::open(['url' => action('EXAM\ClassSubjectProgressController@store'), 'method' => 'post', 'id' =>'progress_add_form' ]); ?>
         ...
         <div class="row align-items-center">
             ...
             <div class="col-sm-3">
                 <?php echo Form::select('chapter', $chapters, null, ['class' => 'form-select select2 ', 'required', 'id' => 'chapter_number', 'style' => 'width:100%', 'placeholder' => __('messages.all')]); ?>
    ...
    <?php /**PATH C:\scsserver\htdocs\oCRSCHOOL\resources\views/Exam/progress/partials/progress.blade.php ENDPATH**/ ?>