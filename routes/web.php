...
|
*/
Route::middleware(['auth','SetSessionData','superadmin'])->group(function () {
...
Route::get('/global_configuration', function () {
    return view('admin/global_configuration/global_configuration');
});
