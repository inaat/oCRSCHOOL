...
class CurriculumController extends Controller
{
    ...
    public function index($class_id)
    {
            ...
            return Datatables::of($ClassSubjects)
                ->addColumn(
                    ...
                    function ($row) {
                        ...
                        $html.='<li><a class="dropdown-item  edit_class_subject_button"data-href="' . action('Curriculum\CurriculumController@edit', [$row->id]) . '"><i class="bx bxs-edit "></i> ' . __("lang.edit") . '</a></li>';               
                        ...
                        $html.='<li><a class="dropdown-item  delete_class_subject_button"data-href="' . action('Curriculum\CurriculumController@destroy', [$row->id]) . '"><i class="bx bxs-trash "></i> ' . __("lang.delete") . '</a></li>';               
                ...
                ->editColumn('subject_name', function ($row)  {
                    return '<div><a  href="' . action('Curriculum\ClassSubjectLessonController@show', [$row->id]) . '">
        ...
        return view('Curriculum\class_wise_subject.index')->with(compact('class_id'));
    }
    ...
    public function create($class_id)
    {
        ...
        //     abort(403, 'Unauthorized action.');
        // }
        $class_detail = Classes::where('id', $class_id)->first();

        return view('Curriculum\class_wise_subject.create')->with(compact('class_detail'));
    }
    /**
    ...
    public function update(Request $request, $id)
    {
        ...
        if (request()->ajax()) {
            try {
                $input = $request->only(['name','code','chapters','description','passing_percentage']);
