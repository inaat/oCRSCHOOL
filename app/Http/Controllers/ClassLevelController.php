        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($classLevel)
                ->addColumn(
                    ...
                    <button data-href="{{action(\'ClassLevelController@edit\', [$id])}}" class="btn btn-sm btn-primary edit_class_level_button"><i class="bx bxs-edit f-16 mr-15 text-white"></i> @lang("lang.edit")</button>
                        &nbsp;


                        <button data-href="{{action(\'ClassLevelController@destroy\', [$id])}}" class="btn btn-sm btn-danger delete_class_level_button"><i class="bx bxs-trash f-16 text-white"></i> @lang("lang.delete")</button>
